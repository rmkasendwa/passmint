...
export function HomePageContent({
  ...
  const dateStart = filters.start ?? "";
  const dateEnd = filters.end ?? "";
...
function filterEvents(events: Event[], filters: Required<HomePageFilters>) {
  const normalizedQuery = filters.q.trim().toLowerCase();
  const activeStart = filters.start;
