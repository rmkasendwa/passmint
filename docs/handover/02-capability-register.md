...
Status reflects the inspected local source on 7 September 2026, not a deployed-release audit. “Working tree” means uncommitted ticket-type changes were included in the inspection.
...
| Ticket categories and sale windows | Working-tree addition | [Schema](../../prisma/schema.prisma), event/ticket services and [category manager](../../apps/web/components/ticket-type-manager.tsx); price, quantity, capacity, limits and windows |
